...
namespace ProteinTrackerClient.ProteinTrackerService {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="User", Namespace="localhost")]
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="localhost", ConfigurationName="ProteinTrackerService.ProteinTrackingServiceSoap")]
    public interface ProteinTrackingServiceSoap {
        
        // CODEGEN: Generating message contract since element name HelloWorldResult from namespace localhost is not marked nillable
        [System.ServiceModel.OperationContractAttribute(Action="localhost/HelloWorld", ReplyAction="*")]
        ...
        [System.ServiceModel.OperationContractAttribute(Action="localhost/AddProtein", ReplyAction="*")]
        int AddProtein(int userId, int amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="localhost/AddProtein", ReplyAction="*")]
        System.Threading.Tasks.Task<int> AddProteinAsync(int userId, int amount);
        
        // CODEGEN: Generating message contract since element name name from namespace localhost is not marked nillable
        [System.ServiceModel.OperationContractAttribute(Action="localhost/AddUser", ReplyAction="*")]
        ...
        // CODEGEN: Generating message contract since element name ListUsersResult from namespace localhost is not marked nillable
        [System.ServiceModel.OperationContractAttribute(Action="localhost/ListUsers", ReplyAction="*")]
    ...
    public partial class HelloWorldRequest {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Name="HelloWorld", Namespace="localhost", Order=0)]
    ...
    public partial class HelloWorldResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Name="HelloWorldResponse", Namespace="localhost", Order=0)]
    ...
    public partial class AddUserRequest {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Name="AddUser", Namespace="localhost", Order=0)]
    ...
    public partial class AddUserResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Name="AddUserResponse", Namespace="localhost", Order=0)]
    ...
    public partial class ListUsersRequest {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Name="ListUsers", Namespace="localhost", Order=0)]
    ...
    public partial class ListUsersResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Name="ListUsersResponse", Namespace="localhost", Order=0)]
    ...
    public partial class ProteinTrackingServiceSoapClient : System.ServiceModel.ClientBase<ProteinTrackerClient.ProteinTrackerService.ProteinTrackingServiceSoap>, ProteinTrackerClient.ProteinTrackerService.ProteinTrackingServiceSoap {
        ...
        public int AddProtein(int userId, int amount) {
            return base.Channel.AddProtein(userId, amount);
        }
        
        public System.Threading.Tasks.Task<int> AddProteinAsync(int userId, int amount) {
            return base.Channel.AddProteinAsync(userId, amount);
        }
